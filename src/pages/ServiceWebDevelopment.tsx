  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section 
        ...
        style={{
          backgroundImage: `url('https://aixtitpk7yzp6scq.public.blob.vercel-storage.com/0002_1_website-builder-poster-psychedelic-retro_gsZSZBqIQlWHIBKQ_Zvqdg_bqBxMixBQBqAS26DXoEZ9A.jpeg')`,
      ...
      >
        ...
        <div className="container-custom relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <Badge className="mb-6 bg-primary/20 text-primary border border-primary/30 text-sm px-4 py-2">WEB DEVELOPMENT</Badge>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
              <span className="text-white drop-shadow-2xl">Custom Web</span>
              <span className="text-primary block drop-shadow-2xl">Development</span>
            </h1>
